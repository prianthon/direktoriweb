      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li ><a href="stores.php">Tempat</a></li>
            <li ><a href="news.php">Berita</a></li>
            <li class="active"><a href="admin_access.php">Akses Admin</a></li>
    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Perbarui akses pengguna</h3>
        </div>
                ...
                <div class="col-md-7">
                  ...
                  <form action="" method="POST">
                      ...
                      <div class="input-group">
                        ...
                        <input type="password" class="form-control" placeholder="Katasandi sebelumnya" name="password_current" onkeypress='validateField(event)' required>
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="password" class="form-control" placeholder="Katasandi" name="password" onkeypress='validateField(event)' required>
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="password" class="form-control" placeholder="Ulangi katasandi" name="password_confirm" onkeypress='validateField(event)' required>
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Nama lengkap" name="name" required value="<?php echo $user->name; ?>">
                      </div>
                      ...
                      <br /> 
                      <p>
                          <button type="submit" name="submit" class="btn btn-info"  role="button">Simpan</button> 
                          <a class="btn btn-info" href="admin_access.php" role="button">Batal</a>
                      </p>
                  </form> 
