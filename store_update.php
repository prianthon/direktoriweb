    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Perbarui Tempat</h3>
        </div>
        ...
        <div class="panel-body">
              <div class="row">
                <div class="col-md-7">
                  ...
                  <form action="" method="POST">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nama Tempat" name="store_name" required value="<?php echo $store->store_name; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Alamat Lengkap" name="store_address" required value="<?php echo $store->store_address; ?>">
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="No Telepon" name="phone_no" value="<?php echo $store->phone_no; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="No SMS" name="sms_no" value="<?php echo $store->sms_no; ?>">
                      </div>
                      ...
                      <div class="input-group" style="width:100%;" >
                        <select class="form-control" style="width:100%;" name="featured">
                          <option value="-1"  >Pilih jika tempat ingin ditampilkan</option>
                          <option value="1" <?php echo $store->featured == 1 ? "selected" : ""; ?>>Tampilkan tempat</option>
                          <option value="0" <?php echo $store->featured == 0 ? "selected" : ""; ?>>Jangan tampilkan tempat</option>
                        </select>
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Klik untuk Latitude" name="lat" onkeypress='validateLatLng(event)' id="latitude" required value="<?php echo $store->lat; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Klik untuk Longitude" name="lon" onkeypress='validateLatLng(event)' id="longitude" required value="<?php echo $store->lon; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <textarea type="text" class="form-control" placeholder="Deskripsi Lengkap" rows="10" name="store_desc" id="details"><?php echo $store->store_desc; ?></textarea>
                      </div>

                      <br /> 
                      <p>
                          <button type="submit" name="submit" class="btn btn-info" onclick="checkInput()" role="button">Simpan</button> 
                          <a class="btn btn-info" href="stores.php" role="button">Batal</a>
                      </p>
                  </form> 
                ...
                <div class="col-md-5">
                  <h4>Klik peta untuk dapatkan latitude/longitude:</h4>
