    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Perbarui berita</h3>
        </div>
              ...
              <div class="row">
                ...
                <div class="col-md-7">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Judul berita" name="news_title" required value="<?php echo $news->news_title; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="URL berita" name="news_url" required value="<?php echo $news->news_url; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Url foto" name="photo_url" value="<?php echo $news->photo_url; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <textarea type="text" class="form-control" placeholder="Konten berita" rows="10" name="news_content" id="details"><?php echo $news->news_content; ?></textarea>
                      </div>
                ...
                <div class="col-md-5">
                  ...
                  <h4>Bukan URL, unggah melalui berkas</h4>
                    ...
                    <br /> 
                      <p>
                          ...
                          <a class="btn btn-info" href="news.php" role="button">Batal</a>
                      </p>
