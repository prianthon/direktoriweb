    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          <h4 class="panel-title pull-left" style="padding-top: 7px;">Galeri Foto</h4>
                                      ...
                                      echo "<div class='col-sm-6 col-md-4'>";
                                        echo "<div class='thumbnail'>";
                                            ...
                                            echo "<div class='caption'>";
                                                  echo "<p>";
                                                      echo "<a href='$updateUrl' class='btn btn-primary btn-xs' role='button'>Sunting</a> ";
                                                      echo "<button  class='btn btn-primary btn-xs' data-toggle='modal' data-target='#modal_$photo_store->photo_id'>Foto Besar</button> ";
                                                      echo "<button  class='btn btn-primary btn-xs' data-toggle='modal' data-target='#delete_modal_$photo_store->photo_id'>Hapus</button>";
                                                  echo "</p>";
                                            echo "</div>";
                                        echo "</div>";
                                      echo "</div>";
                                                  ...
                                                  <div class='modal-dialog'>
                                                      <div class='modal-content'>
                                                          <div class='modal-header'>
                                                                ...
                                                                <h4 class='modal-title' id='myModalLabel'>Menghapus Galeri Foto </h4>
                                                          </div>
