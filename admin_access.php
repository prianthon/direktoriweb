    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
          <h4 class="panel-title pull-left" style="padding-top: 7px;">Pengguna Admin</h4>
          <div class="btn-group pull-right">
            <!-- <a href="seller_insert.php" class="btn btn-default btn-sm">Tampah penjual</a> -->
                  ...
                  if($users != null) {
                    ...
                    foreach ($users as $user)  {
                          ...
                          if($user->deny_access == 1) {
                            echo "<td><a href='$featuredUrl'>boleh</a></td>";
                          }
                          else {
                            echo "<td><a href='$featuredUrl'>Larang</a></td>";
                          }
