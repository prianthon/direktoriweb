      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="categories.php">Kategori</a></li>
    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Perbarui Kategori</h3>
        </div>
              ...
              <div class="row">
                <div class="col-md-7">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nama Kategori" name="category" required  value="<?php echo $category->category; ?>">
                      </div>
                ...
                <div class="col-md-5">
                  ...
                  <h4>Bukan sebuah URL, unggah melalui berkas</h4>
                    ...
                    <br /> 
                      <p>
                          ...
                          <a class="btn btn-info" href="categories.php" role="button">Batal</a>
                      </p>
